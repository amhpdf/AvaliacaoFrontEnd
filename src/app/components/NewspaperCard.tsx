...
export default function NewspaperCard(newspaper: NewsProps) {
  return (
    <div
      key={newspaper.id}
      className="group mb-4 flex h-[320px] w-[320px] max-w-xs flex-col gap-4 rounded-md border border-amhp-zinc-300/20 bg-amhp-gray-300/5 p-4 shadow-md"
    >
      ...
      <Link href="/" className="flex flex-col gap-2">
        ...
        <h2 className="font-alt text-xl font-semibold leading-none tracking-tight text-amhp-gray-400 hover:underline">
          {limitName(newspaper.titulo, 82)}
        </h2>
      </Link>
    </div>
  )
